...
from Controlador.Externas.PlegamientoController import PlegamientoController

class PlegamientoExterna(QMainWindow):
    def __init__(self, cambiar_ventana):
        ...
        titulo = QLabel("Ciencias de la Computación II - Método Plegamiento (Externa)")
    ...
    def guardar_estructura(self):
        ruta, _ = QFileDialog.getSaveFileName(self, "Guardar estructura", "plegamiento_externa.json", "JSON (*.json)")
        if ruta:
            try:
